...
/// <summary>
/// Iterating from CalculateAverageSpan2, continue trying to reduce allocations and duration without splitting work asynchronously and without using multiple threads.
/// </summary>
public static class CalculateAverageStreamReader
{
